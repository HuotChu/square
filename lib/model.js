define(function () {
    ...
    Model.__proto__ = {
        _data: {
            ...
            //      _data.reminders.dataArray === true
            //      _data.user.topicNode === true
            //      _data.user.lists.dataArray === true
            //      _data.user.name.dataObject === true
            //      _data.user.sessions-today.dataNode === true
            //      _data.user.uid.dataObject === undefined (false)
            //
