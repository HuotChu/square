...
var square = (function() {
    ...
    /**
     * Makes Get and Post xhr requests
     * @example
     * // sample uri passing 2 args
     * 'data/json/users.json?uid=123&active=true'
     * // returns xhr object with result of call in xhr.response
     * // xhr.uriArgs.uid == 123 & xhr.uiArgs.active == true
     * @param {string} uri - path to desired resource, plus optional uri args passed as query string
     * @param {string} [post=false] - defaults to 'GET' (false), otherwise 'POST' (true)
     * @returns {Promise} Promise - resolves with the xhr object
     * @returns {object} xhr - entire xhr object
     * @returns {object} xhr.response - response from the xhr call
     * @returns {object} xhr.uriArgs - properties and values match key/value pairs on uri args
     */
    var request = function(uri, post) {
        ...
        return new Promise(function(resolve, reject) {
            ...
            xhr.open(post !== true ? 'GET' : 'POST', resource);
    ...
    /**
     * Interface for the temple templating engine
     * @interface
     *
     */
    var temple = (function() {
        ...
        /**
         * Uses a box object to construct the view and optionally attach it to a destination.
         * @param box
         * @returns {Promise.<T>|*}
         */
    ...
    /**
     * Creates a new box - a box is technically a document fragment with added properties to make it more useful.
     */
    var box = (function() {
        'use strict';
        ...
        /**
         * @constructs box
         * @param {object} config - configuration for a new box
         * @param {object} config.data - map of key/value pairs where each key matches a template variable name
         * @param {object} config.model - model where the data is coming from
         * @param {HTMLElement} [config.target] - DOM element where generated html will be inserted
         * @param {string} config.template - path to the template file to use when creating the view for this box
         * @param {object} [config.templates] - key/value pairs where each key represents a named template and the value is a string of html
         * @param {Array.<object>} [config.domEvents] - //this should reference domEvents API
         * @param {Array.<object>} [config.modelEvents] - //this should reference modelEvents API
         */
