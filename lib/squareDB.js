...
define(['./eventHub'], function(eventHub) {
            ...
            'go': function (matchesArray) {
                ...
                if (this._aggregate) {
                    switch (this._aggregate) {
                        case 'min': result = minMaxSumAvg(result, 'min');
                            break;
                        case 'max': result = minMaxSumAvg(result, 'max');
                            break;
                        case 'sum': result = minMaxSumAvg(result, 'sum');
                            break;
                        case 'avg': result = minMaxSumAvg(result, 'avg');
                            break;
                        case 'count':
                            break;
                        default:
    ...
    var minMaxSumAvg = function (dataArray, operation) {
