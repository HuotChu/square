    ...
    Where.prototype = {
        ...
        'and': function (column, comperator, control) {
            var oldMatches = Array.from(this.matches),
                andWhere = new this.constructor(column, comperator, control, this.lastTable),
        ...
        'or': function (column, comperator, control) {
            var oldMatches = Array.from(this.matches),
                orWhere = new this.constructor(column, comperator, control, this.lastTable),
