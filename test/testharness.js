 ...
 *
 *
 * Ported to Require.js module [& other improvements] by Scott Bishop - 2/25/2015
 *
 *
 * == Introduction ==
 *
...
define(function () {
    ...
    harness.next_default_name = function()
    {
    ...
    harness.test = function(func, name, properties)
    {
    ...
    harness.async_test = function(func, name, properties)
    {
    ...
    harness.setup = function(func_or_properties, maybe_properties)
    {
        var func = null;
        var properties = {};
    ...
    harness.generate_tests = function(func, args, properties) {
    ...
    harness.on_event = function(object, event, callback)
    {
    ...
    harness.assert_true = function(actual, description)
    {
        assert(actual === true, "assert_true", description,
            "expected true got ${actual}", {actual:actual});
    };

    harness.assert_false = function(actual, description)
    {
    ...
    harness.assert_equals = function(actual, expected, description)
    {
        /*
    ...
    harness.assert_not_equals = function(actual, expected, description)
    {
        /*
    ...
    harness.assert_in_array = function(actual, expected, description)
    {
    ...
    harness.assert_object_equals = function(actual, expected, description)
    {
    ...
    harness.assert_array_equals = function(actual, expected, description)
    {
    ...
    harness.assert_approx_equals = function(actual, expected, epsilon, description)
    {
        /*
    ...
    harness.assert_less_than = function(actual, expected, description)
    {
        /*
    ...
    harness.assert_greater_than = function(actual, expected, description)
    {
        /*
    ...
    harness.assert_less_than_equal = function(actual, expected, description)
    {
        /*
    ...
    harness.assert_greater_than_equal = function(actual, expected, description)
    {
        /*
    ...
    harness.assert_regexp_match = function(actual, expected, description) {
        /*
    ...
    harness.assert_class_string = function(object, class_string, description) {
        assert_equals({}.toString.call(object), "[object " + class_string + "]",
            description);
    };

    harness.assert_own_property = function(name) {
    ...
    harness.assert_inherits = harness.assert_idl_attribute = function(name) {
        return function (object, property_name, description)
        {
    ...
    harness.assert_readonly = function(object, property_name, description)
    {
    ...
    harness.assert_throws = function(code, func, description)
    {
        try
        {
            func.call(this);
    ...
    harness.assert_unreached = function(description) {
        assert(false, "assert_unreached", description,
            "Reached unreachable code");
    };

    harness.assert_any = function(assert_func, actual, expected_array)
    {
    ...
    harness.add_start_callback = function(callback) {
        tests.start_callbacks.push(callback);
    };

    harness.add_result_callback = function(callback)
    {
        tests.test_done_callbacks.push(callback);
    };

    harness.add_completion_callback = function(callback)
    {
    ...
    Output.prototype.show_results = function (tests, harness_status)
    {
        ...
        stylesheet.setAttribute("href", "testharness.css");
        ...
        forEach(output_document.querySelectorAll("section#summary label"),
            function(element)
            {
                harness.on_event(element, "click",
                    function(e)
                    {
    ...
    harness.add_start_callback(function (properties) {output.init(properties);});
    harness.add_result_callback(function (test) {output.show_status(tests);});
    harness.add_completion_callback(function (tests, harness_status) {output.show_results(tests, harness_status);});
     ...
     * Utility funcions
     */
    var assert = harness.assert = function(expected_true, function_name, description, error, substitutions)
    {
